<template>
	 <view class="uni-tabbar">
	    <view class="uni-tabbar__item" v-for="(item,index) in list.tabbarList" :key="index" @tap="changeTab(item.pagePath)">
	        <!-- 图片图标 -->
	        <!-- <view v-if="false" class="uni-tabbar__bd"> -->
	            <view class="uni-tabbar__icon">
					<!-- 当前路径 -->
	                <image v-if="item.pagePath == props.currPath" class="uni-w-42" mode="aspectFit" :src="item.selectedIconPath"></image>
	                <!-- 其他路径 -->
